...
import argparse
from .ingest import fetch_newsapi, _parse_date_arg

def cmd_ingest(args: argparse.Namespace) -> None:
    iso_date = _parse_date_arg(args.date).isoformat()
    if args.newsapi:
        outfile = fetch_newsapi(outdir=args.outdir, date=iso_date)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pi.add_argument("--date", default="today")  # 'today'|'yesterday'|'YYYY-MM-DD'
