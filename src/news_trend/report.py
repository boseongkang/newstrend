...
def write_report(date_str: str, kind: str = "raw",
                 indir: str = "data", outdir: str = "reports",
                 sample_limit: int = 50) -> str:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--kind", choices=["raw","silver"], default="raw")
